    ...
    setInterval(async () => { 
        if (biography_var == 'true') {
            if (conn.user.jid.startsWith('90')) { // Turkey
                ...
                const biography = '📅 ' + utch + '\n⌚ ' + ov_time + '\n\n🐺\n᳆⃞⃚ 🎓ʀͥᴇᷧᴀͫʟ ☕︎ ᴀᴛᴛɪᴛᴜᴅᴇ ɪꜱ ᴀ ʟɪᴛᴛʟᴇ\nᴛʜɪɴɢ ᴛʜᴀᴛ ᴍᴀᴋᴇꜱ ʙɪɢ ᴅɪꜰꜰᴇʀᴇɴᴄᴇ ☕︎\nɪ ᴀᴍ ᴋᴀᴡᴇᴇꜱʜᴀ ᴄʜᴀᴍᴏᴅ'
...
${chalk.blue.italic('ℹ️ Connecting to WhatsApp... Please Wait.')}`);
    ...
    conn.on('message-new', async msg => {
        ...
        if (config.SUPPORT == '918921936055-1626577715') {     
        ...
        events.commands.map(
            async (command) =>  {
                ...
                if ((command.on !== undefined && (command.on === 'image' || command.on === 'photo')
                    ...
                    if ((OWN.ff == "918921936055,0" && msg.key.fromMe === false && command.fromMe === true &&
